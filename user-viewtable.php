...
<html>
	...
	<body>
		...
		<div id="header">
			<ul>
				...
				<li class="mainoptions"><a href="complaint-form.php">Complaint Form</a></li>
				<li class="mainoptions"><a href="#">Complaint List</a></li>
	...
	$sql="SELECT * FROM `complaint` WHERE `email`='$_SESSION[email]'";
